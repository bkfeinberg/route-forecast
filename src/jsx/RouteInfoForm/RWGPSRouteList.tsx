...
import { Combobox, ComboboxOptionProps, useCombobox, Group, Text, Button } from '@mantine/core'
    ...
    return (
        <Combobox
            ...
            onOptionSubmit={(selected: string, options: ComboboxOptionProps) => {
                ...
                if (options.children && Array.isArray(options.children)) {
                    ...
                    setSelectedName(options.children[2]);
                } else {
        ...
        >
            <Combobox.Target>
              ...
              >             
              {selectedName === '' ? route_id : selectedName}     
              </Button>
            </Combobox.Target>

            <Combobox.Dropdown className="dropdown">
                <Combobox.Options mah={400} style={{ overflowY: 'scroll', scrollbarGutter: 'stable' }}>
